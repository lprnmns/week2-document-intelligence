...
| CI: lint, type, unit/contract/security/evaluation/image checks | §22, p. 22 | PASS | `.github/workflows/document-intelligence-service.yml`, `.github/pull_request_template.md`, `pyproject.toml` | Dependency audit is currently advisory (`pip-audit || true`); branch protection is not claimed/configured here |
